    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-appoinment-active ">
                        <a href="clerk.php" class="non-style-link-menu "><div><p class="menu-text">Clerk</p></a></div>
                    </td>
                </tr>
